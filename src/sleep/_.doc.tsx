    ...
    props: [
        {
            ...
            require: false,
            description:
                "Tiempo en milisegundos para pausar la ejecución. El valor predeterminado es 1000 ms (1 segundo).",
        },
    ],
    returns: [
        {
            ...
            type: "Promise<void>",
            description:
                "La función devuelve una promesa que se resuelve después del tiempo especificado.",
        },
    ],
    useExample: [
        {
