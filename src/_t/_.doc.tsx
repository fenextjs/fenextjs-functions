    ...
    props: [
        {
            ...
            require: true,
            description:
                "Dato que será validado. Si es un string, se aplicará la función de transformación _t si está definida.",
        },
        {
            id: "_t",
            type: "_TFunciton",
            require: false,
            description:
                "Función opcional que transforma el dato si es un string.",
        },
    ],
    returns: [
        {
            ...
            type: "any",
            description:
                "Retorna el dato original o el dato transformado si _t fue aplicada.",
        },
    ],
    useExample: [
        {
