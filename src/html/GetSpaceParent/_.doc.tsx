    ...
    props: [
        {
            ...
            require: true,
            description:
                "Elemento HTML para el cual se calcularán los espacios relativos a su contenedor padre.",
        },
    ],
    returns: [
        {
            ...
            description:
                "Objeto que contiene las distancias (en píxeles) entre el elemento y los bordes superior, izquierdo, derecho y inferior de su contenedor padre.",
        },
    ],
    useExample: [
        {
