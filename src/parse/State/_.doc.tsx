            ...
            props: [
                {
                    ...
                    require: true,
                    description:
                        "Objeto `StateProps` que se convertirá a cadena JSON.",
                },
            ],
            returns: [
                {
                    ...
                    description:
                        "Cadena JSON que representa el objeto `StateProps`, o `undefined` si la entrada es inválida.",
                },
            ],
            useExample: [
                {
            ...
            props: [
                {
                    ...
                    require: true,
                    description:
                        "Cadena JSON que representa un objeto `StateProps`.",
                },
            ],
            returns: [
                {
                    ...
                    description:
                        "Objeto `StateProps` resultante de la cadena JSON, o un objeto con `text` en caso de error.",
                },
            ],
            useExample: [
                {
