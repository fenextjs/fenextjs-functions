            ...
            props: [
                {
                    ...
                    require: true,
                    description:
                        "Objeto `PhoneProps` parcial que se convertirá a cadena JSON.",
                },
            ],
            returns: [
                {
                    ...
                    type: "string",
                    description:
                        "Cadena JSON que representa el objeto `PhoneProps`, o la representación en cadena en caso de error.",
                },
            ],
            useExample: [
                {
            ...
            props: [
                {
                    ...
                    require: true,
                    description:
                        "Cadena JSON que representa un objeto `PhoneProps` parcial.",
                },
            ],
            returns: [
                {
                    ...
                    description:
                        "Objeto parcial `PhoneProps` resultante de la cadena JSON, o un objeto con `number`, `code` y `tel` extraídos en caso de error.",
                },
            ],
            useExample: [
                {
