            ...
            props: [
                {
                    ...
                    require: true,
                    description:
                        "Objeto con el texto a convertir y el tipo de fecha.",
                },
            ],
            returns: [
                {
            ...
            props: [
                {
                    ...
                    require: false,
                    description:
                        "La fecha a convertir en texto. Si no se proporciona, se usará la fecha actual.",
                },
                {
                    id: "type",
                    ...
                    require: true,
                    description:
                        "El tipo de texto a crear a partir de la fecha.",
                },
            ],
            returns: [
                {
            ...
            props: [
                {
                    ...
                    require: true,
                    description:
                        "La fecha de la cual obtener el valor del mes.",
                },
            ],
            returns: [
                {
            ...
            props: [
                {
                    ...
                    require: true,
                    description:
                        "La fecha de la cual obtener el valor de la semana.",
                },
            ],
            returns: [
                {
            ...
            props: [
                {
                    ...
                    require: true,
                    description:
                        "La fecha de la cual obtener el valor de la hora.",
                },
            ],
            returns: [
                {
            ...
            returns: [
                {
                    ...
                    type: "string",
                    description:
                        "La fecha formateada según las opciones especificadas.",
                },
            ],
            useExample: [
                {
