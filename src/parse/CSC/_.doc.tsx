            ...
            props: [
                {
                    ...
                    require: true,
                    description:
                        "Objeto `CSCProps` que contiene los datos de país, estado y ciudad para convertir a cadena.",
                },
            ],
            returns: [
                {
                    ...
                    description:
                        "Objeto `CSCStringProps` con los datos convertidos a cadenas, o `undefined` en caso de entrada inválida.",
                },
            ],
            useExample: [
                {
            ...
            props: [
                {
                    ...
                    require: true,
                    description:
                        "Representación en cadena de un objeto CSC (`CSCStringProps`) que contiene los datos de país, estado y ciudad.",
                },
            ],
            returns: [
                {
                    ...
                    description:
                        "Objeto `CSCProps` con los datos convertidos de cadena a objetos, o `undefined` en caso de entrada inválida.",
                },
            ],
            useExample: [
                {
