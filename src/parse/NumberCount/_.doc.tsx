export default {
    ...
    props: [
        ...
        },
        {
            ...
            require: false,
            description:
                "Opciones para personalizar el formato del número, como decimales, estilo, etc.",
        },
    ],
    returns: [
        {
            ...
            type: "string",
            description:
                "La representación en cadena del número formateado, con comas separando miles y decimales si se especifica.",
        },
    ],
    useExample: [
        {
