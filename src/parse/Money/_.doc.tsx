    ...
    props: [
        {
            ...
            require: true,
            description:
                "El número o cadena que se debe formatear como dinero.",
        },
        {
            id: "options",
            ...
            require: false,
            description:
                "Opciones para personalizar el formato de número. Se pasa al método Intl.NumberFormat.",
        },
    ],
    returns: [
        {
            ...
            type: "string",
            description:
                "La cadena formateada en formato de dinero, incluyendo el símbolo '$'.",
        },
    ],
    useExample: [
        {
