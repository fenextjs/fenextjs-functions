    ...
    props: [
        {
            ...
            require: true,
            description:
                "La unidad que se debe convertir a su forma en texto. Puede ser una de las unidades definidas en Unit_Distance, Unit_Volumen o Unit_Weight.",
        },
    ],
    extras: [
        {
            ...
            tableItems: [
                {
                    ...
                    Descripcion:
                        "Unidades relacionadas con distancias (por ejemplo, metros, centímetros).",
                    Default: "CM",
                },
                {
                    Nombre: "Unit_Volumen",
                    Descripcion:
                        "Unidades relacionadas con el volumen (por ejemplo, litros, galones).",
                    Default: "L",
                },
                {
                    Nombre: "Unit_Weight",
                    Descripcion:
                        "Unidades relacionadas con el peso (por ejemplo, kilogramos, gramos).",
                    Default: "KG",
                },
            ],
        },
    ...
    returns: [
        {
            ...
            type: "string",
            description:
                "La representación en texto de la unidad proporcionada.",
        },
    ],
    useExample: [
        {
