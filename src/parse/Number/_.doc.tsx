    ...
    props: [
        {
            ...
            type: "number | string",
            require: true,
            description: "El número o cadena que se debe analizar y convertir en número.",
        }
    ],
    returns: [
        {
            id: "parsedNumber",
            type: "number",
            description: "El número resultante después de analizar la cadena o número de entrada. Si no es posible convertirlo, se devuelve 0.",
        }
    ],
    useExample: [
        {
