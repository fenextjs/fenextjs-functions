export default {
    id: "parseCsvToJson",
    name: "parseCsvToJson",
    description: "Convierte un archivo CSV a formato JSON. La primera línea del archivo se usa como los encabezados del objeto, y cada línea subsecuente se mapea a un objeto con claves basadas en esos encabezados. También maneja campos con separadores múltiples (como el carácter '|').",
    functions: [
        {
            id: "parseCsvToJson",
            name: "parseCsvToJson",
