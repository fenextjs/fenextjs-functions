    ...
    props: [
        {
            ...
            require: true,
            description:
                "Cadena de texto que contiene el contenido del archivo CSV.",
        },
    ],
    returns: [
        {
            ...
            description:
                "Objeto que contiene los encabezados y los datos convertidos a formato JSON. Si ocurre un error durante el procesamiento, retorna un objeto vacío.",
        },
    ],
    useExample: [
        {
