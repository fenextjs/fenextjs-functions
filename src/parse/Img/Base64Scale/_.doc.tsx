export default {
    ...
    props: [
        ...
        },
        {
            ...
            require: false,
            description:
                "Altura deseada para la imagen escalada. Si se establece en 'auto', se ajustará automáticamente para mantener la proporción.",
            default: "'auto'",
        },
        {
            id: "quality",
            ...
            require: false,
            description:
                "Calidad de la imagen resultante en un rango de 0 a 1, donde 1 representa la máxima calidad.",
            default: 1,
        },
    ],
    returns: [
        {
            ...
            description:
                "Cadena en formato base64 de la imagen escalada y comprimida, o `undefined` si ocurre un error.",
        },
    ],
    useExample: [
        {
