    ...
    props: [
        {
            ...
            require: true,
            description:
                "Cadena en formato base64 que representa la imagen original.",
        },
        {
            id: "name",
            type: "string",
        ...
        },
        {
            ...
            require: false,
            description:
                "Calidad de las imágenes generadas, en un rango de 0 a 1. El valor predeterminado es 1.",
        },
    ],
    returns: [
        {
            ...
            type: "ImgDataProps",
            description:
                "Objeto `ImgDataProps` que contiene la imagen original en base64 y múltiples versiones escaladas en distintas resoluciones.",
        },
    ],
    useExample: [
        {
